...
using MixPlannerApi.TaskList;
using MixPlannerApi;
using MixPlannerApi.Data;
using MixPlannerApi.Health;
...
api.MapGroup("List").MapTaskListEndpoints();
api.MapGroup("Item").MapTaskItemEndpoints();
app.MapHealthEndpoint();


app.MapHub<LiveUpdateHub>("/LiveUpdateHub", options => { });
